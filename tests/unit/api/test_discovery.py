...
def test_local_discovery_search_snippet_mapping(mock_service_cls):
    ...
    mock_service.search.return_value = {
        "results": [
            {"case_id": "1", "metadata": {"summary": "Metadata Summary"}, "merged_score": 0.9},
            {"case_id": "2", "metadata": {}, "vector": {"text": "Vector Text"}, "merged_score": 0.8},
            {"case_id": "3", "metadata": {}, "record": {"text": "Record Text"}, "merged_score": 0.7},
        ],
        "total": 3,
    }
