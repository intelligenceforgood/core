...
- Keep documentation and planning artifacts in sync with code—material changes should update `planning/change_log.md`, `docs/design/architecture.md`, or `docs/development/dev_guide.md` as appropriate.
