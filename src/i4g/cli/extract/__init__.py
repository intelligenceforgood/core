...
def extract_ocr(
    ...
    code = tasks.ocr(input_path=input_path, output_path=output_path)
    if code:
...
def extract_extraction(
    ...
    code = tasks.extraction(input_path=input_path, output_path=output_path)
    if code:
        raise typer.Exit(code)
...
def extract_semantic(
    ...
    code = tasks.semantic(input_path=input_path, output_path=output_path, model=model)
    if code:
        raise typer.Exit(code)
