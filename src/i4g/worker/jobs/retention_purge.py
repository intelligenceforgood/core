...
Phase 2 cascades deletion to PII vault tokens, evidence files, and vector
embeddings.
...
def main(*, dry_run: bool = False) -> int:
    ...
    try:
        ...
        LOGGER.warning("Could not build PII vault token store — PII cleanup will be skipped")
