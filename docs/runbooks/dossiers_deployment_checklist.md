...
2. Update the Terraform variables (`infra/environments/app/{dev,prod}/terraform.tfvars`) if you change the tag.
...
- Terraform settings examples: `infra/environments/app/dev/terraform.tfvars`
